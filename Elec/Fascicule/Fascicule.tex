...
\begin{figure}[h!]
    \begin{center}
        \begin{circuitikz}
            ...
            \node[below left] at (3,2) {$ \SI{3.0}{V}$};
            \node[above] (C) at (6,2) {C};
            \node[below left]at (6,2) {$ \SI{2.5}{V}$};
...
\begin{figure}[h!]
    \begin{center}
        \begin{circuitikz}
            ...
            \draw (3,2) to[R = \shifttext{-0.9cm}{$r$}, v^<=$U_\text{BG}$] (3,0);
            \draw (6,2) to[R = \shifttext{-1.cm}{$r_2$}, v^<=$U_\text{CF}$] (6,0);
            \node[above] (A) at (0,2) {A};
            \node[below] at (0,2) {$ \SI{5.0}{V}$};
            \node[above] (B) at (3,2) {B};
            \node[below left] at (3,2) {$ \SI{3.0}{V}$};
...
\begin{center}
    \begin{circuitikz}[scale=1]
        ...
        (0,0)
        ;
        \draw[] (2,0) to[R=\shifttext{-1cm}{$r$}]
        (2,-2);
        \draw[] (4,0) to[R=\shifttext{-1cm}{$r_{2}$}]
        (4,-2);
        \node[left] (A) at (0,0) {A};
...
\begin{center}
    \begin{circuitikz}[scale=1]
        \draw (0,0) node {$\bullet$} to[R=\raisebox{-.5cm}{$R_1$}]
        (2,0) to[R=\raisebox{-.5cm}{$R$}]
        (4,0) to[R=\shifttext{-1.15cm}{$R_{eq,1}$}]
        (4,-2) node {$\bullet$} --
        (2,-2) to[R=\raisebox{.4cm}{$R'$}]
        (0,-2) --
        (0,0)
...
\begin{center}
    \begin{circuitikz}[scale=1]
        \draw (0,0) node {$\bullet$} to[R=\raisebox{-.5cm}{$R_1$}]
        (2,0) --
        (4,0) to[R=\shifttext{-1.15cm}{$R_{eq,2}$}]
        (4,-2) node {$\bullet$} --
        (2,-2) to[R=\raisebox{.4cm}{$R'$}]
        (0,-2) --
        (0,0)
...
\begin{center}
    \begin{circuitikz}[scale=1]
        \draw (0,0) node {$\bullet$} to[R=\raisebox{-.5cm}{$R_1$}]
        (2,0) to[R=\shifttext{-1.15cm}{$R_{eq,3}$}]
...
\begin{center}
    \begin{circuitikz}[scale=1]
        \draw (0,0) node {$\bullet$} --
        (2,0) to[R=\shifttext{-1.15cm}{$R_{eq,4}$}]
        (2,-2) node {$\bullet$} --
        (0,-2) to[R=\shifttext{1.15cm}{$R'$}]
        (0,0)
        ;
        \node[left] (A) at (0,0) {A};
        \node[right] (B) at (2,-2) {B};
...
\begin{center}
    \begin{circuitikz}
        \draw (0,0) node {$\bullet$} to[R=\raisebox{-.5cm}{$R_{eq}$}]
        (2,0) node {$\bullet$}
        ;
        \node[left] (A) at (0,0) {A};
...
\begin{center}
    \begin{circuitikz}
        ...
        (4,0) to[R=\shifttext{-1.15cm}{$R$}]
        (4,-1.5) to[R=\shifttext{-1.15cm}{$R_1$}]
        (4,-3);
        \draw[] (4,0) --
        (6,0) node[above right=10, inner sep=0] (D) {} to[R=\shifttext{-1.15cm}{$R_2$}]
        (6,-1.5) to[R=\shifttext{-1cm}{$r$}]
        (6,-3) node[below right=10, inner sep=0] (E) {} --
        (2,-3);
        \node[left] (A) at (0,0) {A};
        \node[left] (B) at (0,-3) {B};
        \draw[dashed, orange!70] (C) -- (D) -- (E) -- (F) -- (C);
        ...
        \draw[dashed, ForestGreen] (Cg) -- (Cd) -- (Fd) -- (Fg) -- (Cg);
    \end{circuitikz}
\end{center}
...
Et on obtient donc \begin{circuitikz}
    \draw (0,0) node {$\bullet$} node[left] {A} to[R=\raisebox{-.5cm}{$R_{eq}$}]
