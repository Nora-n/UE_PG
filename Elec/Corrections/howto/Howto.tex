...
\begin{NCdefi}{Liste des tcolorboxes}
    ...
    en rouge :
    \begin{itemize}
        \item \Ul{loi} pour \textit{loi} ; 
        \item \Ul{theo} pour \textit{théorème} ;
        \item \Ul{prop} pour \textit{propriété} ;
        \item \Ul{coro} pour \textit{corolaire}.
    \end{itemize}
    Ensuite, il y a en bleu :
    \begin{itemize}
        \item \Ul{demo} pour \textit{démonstration} ;
        \item \Ul{inte} pour \textit{interprétation} ;
        \item \Ul{impl} pour \textit{implication}.
    \end{itemize}
    En vert on trouve :
    \begin{itemize}
        \item \Ul{defi} pour \textit{définition} ;
        \item \Ul{nota} pour \textit{notation}.
    \end{itemize}
    Les tons violets définissent :
    \begin{itemize}
        \item \Ul{impo} pour \textit{important} ;
        \item \Ul{rapp} pour \textit{rappel}.
    \end{itemize}
